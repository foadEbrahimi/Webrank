...
export default function Farakhan() {
  return (
    <div className="Farakhan text-center py-24 px-2 space-y-7">
      ...
      <button className="border-2 border-white bg-transparent text-white text-xl px-4 py-2 rounded-md hover:bg-Primary hover:text-black hover:border-Primary transition-all duration-500">
        فراخوانی برای اقدام
      </button>
    </div>
  );
